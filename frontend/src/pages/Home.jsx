  ...
  return (
    <>
      ...
      <section className="relative min-h-screen bg-[#050505] text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-10 lg:px-12 pt-48 pb-20 text-center">
          {/* Badge */}
          <motion.div
          ...
          {/* Feature cards */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-16 mt-40">
